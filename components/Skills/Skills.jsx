...
const Skills = () => {
    return (
        <div className="skills">
            ...
            <Skill name={'C++'} number={'70'}  elipsesItem={'/assets/img/skills/elipsesItem.svg'} elipse={'/assets/img/skills/70.svg'} iconName={'c++'} icon={'/assets/icon/java.svg'}/>
            <Skill name={'VAADIN'} number={'80'}  elipsesItem={'/assets/img/skills/elipsesItem.svg'} elipse={'/assets/img/skills/80.svg'} iconName={'vaadin'} icon={'/assets/icon/c-plus-plus.svg'}/>
